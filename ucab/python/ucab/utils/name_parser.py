from ucab.algorithms.linear import logistic_regression,logistic_regression_cv,ridge_classifier,ridge_classifier_cv,sgd_classifier,perceptron,linear_regression,ridge,ridge_cv,sgd_regressor
from ucab.algorithms.tree import decision_tree_classifier,decision_tree_regressor,extra_tree_classifier,extra_tree_regressor
from ucab.algorithms.forest import random_forest_classifier,random_forest_regressor,extra_trees_classifier,extra_trees_regressor
from ucab.algorithms.svm import linear_svc,linear_svr
