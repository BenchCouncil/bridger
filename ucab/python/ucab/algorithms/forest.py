...
def random_forest_classifier(
    ...
    if(sparse_replacing in ["csr", "bsr", "csc"]):
        ...
        if(sparse_replacing == "csc"):
            y = relay.nn.sparse_dense_csc(data, S, n_estimator_x_internal_node)
        else:
        ...
        y = relay.nn.sparse_dense_coo(data, S, n_estimator_x_internal_node)
        ...
        y = relay.nn.sparse_dense_dia(data, S, n_estimator_x_internal_node)
